...
export class auto1670050203783 implements MigrationInterface {
    name = 'auto1670050203783'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "last_name" character varying NOT NULL, "name" character varying NOT NULL, "patronymic" character varying, "username" character varying NOT NULL, "birthdate" TIMESTAMP, "phone" character varying, "email" character varying NOT NULL, "gender" "public"."users_gender_enum" NOT NULL DEFAULT 'male', "permission" text NOT NULL, "password" character varying NOT NULL, "bio" character varying NOT NULL, "image" character varying NOT NULL, CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "events" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "type" "public"."events_type_enum" NOT NULL DEFAULT 'event', "type_events" "public"."events_type_events_enum" DEFAULT 'challenge', "type_project" "public"."events_type_project_enum" DEFAULT 'training', "images" text NOT NULL, "descriptions" character varying NOT NULL, "date_start" TIMESTAMP NOT NULL, "date_end" TIMESTAMP, "team_size" character varying, "last_time_registration" TIMESTAMP, "prize" character varying, "creator_id" integer, "tags" integer, CONSTRAINT "REL_39f98b48445861611ea1710807" UNIQUE ("creator_id"), CONSTRAINT "PK_40731c7151fe4be3116e45ddf73" PRIMARY KEY ("id"))`);
